...
go
update TEACHER set GENDER = 'м' where TEACHER='ГДД'
--delete from TEACHER where TEACHER = 'ГДД'
--insert into TEACHER values ('ГДД', 'Глушко Денис Дмитриевич', 'м', 'ИСиТ')
select * from TEACHER
